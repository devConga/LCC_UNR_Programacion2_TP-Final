...
def main():  
    ...
    while(bfs_result is None):
        ...
        dimension, labyrinth, start, objective = get_labyrinth()                # Obtiene la dimension, disposicion y coords de inicio y llegada del laberinto
        ...
        if(bfs_result is None):                                                 # Si BFS no logro encontrar el objetivo, el laberinto no puede resolverse
            ...
            time.sleep(1)                                                       # Da tiempo a que cambie la semilla que genero el laberinto.
        tries +=1
